...
// Script for "Babies Are Born With 300 Bones"
const scenes: SceneScript[] = [
  {
    name: "scene-1-hook",
    script: "Your baby has more bones than you do. Right now. Way more.",
    direction: "warm, surprised, like sharing an amazing secret with a friend",
  },
  {
    name: "scene-2-body",
    script: "Babies are born with about three hundred bones. Adults? Only two hundred and six. As your baby grows, many of those bones fuse together. Those soft spots on their head? That's where the skull bones haven't joined yet... and that's exactly what lets them fit through the birth canal.",
    // no direction — voice stays consistent
  },
  {
    name: "scene-3-cta",
    script: "Subscribe for more mind-blowing baby facts you never knew you needed.",
  },
];

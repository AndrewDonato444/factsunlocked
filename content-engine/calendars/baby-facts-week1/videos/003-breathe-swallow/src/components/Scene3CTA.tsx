...
export const Scene3CTA: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: `radial-gradient(circle at 50% 50%, #2D1B4E, ${COLORS.background})`, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: 60 }}>
      ...
      <div style={{ fontSize: 40, fontWeight: 600, fontFamily: "system-ui, sans-serif", color: COLORS.accent2, textAlign: "center", marginTop: 60, opacity: subOpacity, transform: `translateY(${subY}px)` }}>Subscribe for more<br />baby superpowers</div>
    </AbsoluteFill>
  );
};

...
const scenes = [
  { name: "scene-1-hook", script: "Your newborn's tears? They're fake. Like, literally.", direction: "playful, conspiratorial, like sharing a funny secret" },
  { name: "scene-2-body", script: "Newborns cry. A lot. But here's the thing... they don't actually produce real tears until they're about two to four weeks old. Their tear ducts aren't fully developed yet at birth. They can make all the crying sounds and scrunchy faces from day one, but the actual tears? Those come later. Some babies don't even produce tears until two months old." },
  { name: "scene-3-cta", script: "Subscribe for a new baby fact every day this week." },
];

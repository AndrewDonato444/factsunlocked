...
const scenes = [
  { name: "scene-1-hook", script: "The womb is louder than a vacuum cleaner. Way louder.", direction: "warm, mind-blown, like sharing something that surprised you" },
  { name: "scene-2-body", script: "That shushing sound that calms your baby? It's not random. It mimics the constant whooshing of blood flow they heard for nine months in the womb. And that sound? It's about eighty to ninety decibels. That's louder than a vacuum cleaner. The womb was never silent. It was actually incredibly loud. That's why white noise machines work so well." },
  { name: "scene-3-cta", script: "Subscribe for more baby facts that change how you see parenting." },
];

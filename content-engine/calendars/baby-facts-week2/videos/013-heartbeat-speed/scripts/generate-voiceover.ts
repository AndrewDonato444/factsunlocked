...
function writeWav(filepath: string, pcmData: Buffer, sampleRate = 24000, channels = 1, bitDepth = 16) {
  ...
  header.writeUInt16LE(blockAlign, 32); header.writeUInt16LE(bitDepth, 34);
...
const scenes = [
  {
    name: "scene-1-hook",
    script: "Your baby's heart is beating almost twice as fast as yours. Right now.",
    direction: "warm, amazed, like sharing an incredible secret",
  },
  {
    name: "scene-2-body",
    script: "A newborn's heart beats around 120 to 160 times per minute. An adult's resting heart rate? Only 60 to 100. That's because a baby's heart is tiny — about the size of a walnut. It has to pump faster to push blood through their rapidly growing body. But here's the cool part. As they grow, their heart gets bigger and stronger, and it gradually slows down to adult speed by around age ten.",
  },
  {
    name: "scene-3-cta",

...
export const RemotionRoot: React.FC = () => {
  return (
    <Composition id="BabyFactNoKneecaps" component={MainVideo} durationInFrames={totalFrames} fps={fps} width={1080} height={1920} defaultProps={{ scene1Frames, scene2Frames, scene3Frames }} />
  );
};
